...
import com.kyald.keretaapi.adapters.StatusFoodAdminAdapter;
...
//        code = PreferenceUtils.getInstance().loadDataString(getApplicationContext(), PreferenceUtils.CODE);
    ...
    public void getData(){
        ...
        final String token = PreferenceUtils.getInstance().loadDataString(StatusAdminActivity.this, PreferenceUtils.TOKEN);
...
//                                   makananList.add(new Makanan(1,"rdytrdy"));
                                     dishAdapter = new StatusFoodAdminAdapter(StatusAdminActivity.this,Status_var);

                                     RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(StatusAdminActivity.this);
