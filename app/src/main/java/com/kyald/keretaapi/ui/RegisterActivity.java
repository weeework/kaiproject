...
//        PreferenceUtils.getInstance().saveData(getApplicationContext(), PreferenceUtils.TOKEN, tpoken);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<AuthResponse> call = apiEndpoint.postRegist(uname,email,pass);
...
//                            Toast.makeText(R.this, auth.getToken(),Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(Call<AuthResponse> call, Throwable t) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(RegisterActivity.this, "Register error please check your input",Toast.LENGTH_LONG).show();
