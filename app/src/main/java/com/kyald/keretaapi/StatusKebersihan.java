...
public class StatusKebersihan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_status_kebersihan);
...
//        btn_order.setVisibility(View.GONE);
        ...
        call.enqueue(new Callback<TrainResponse>() {
            ...
            public void onResponse(Call<TrainResponse> call, Response<TrainResponse> response) {
                ...
                final AlertDialog.Builder builderSingle = new AlertDialog.Builder(StatusKebersihan.this);
                builderSingle.setTitle("Pilih kereta");
                final ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(
                        StatusKebersihan.this,
...
//                                rv.setVisibility(View.VISIBLE);
    ...
    private void getData(String code){
        ...
        final String token = PreferenceUtils.getInstance().loadDataString(StatusKebersihan.this, PreferenceUtils.TOKEN);
...
//                                   makananList.add(new Makanan(1,"rdytrdy"));
                                     dishAdapter = new PenumpangAdapter(StatusKebersihan.this,passenggerList);

                                     RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(StatusKebersihan.this);
